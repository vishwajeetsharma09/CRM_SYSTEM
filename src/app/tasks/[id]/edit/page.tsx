...
import { Task, Customer, Lead, Activity } from '@/lib/supabase'
import { getTask, updateTask, getCustomers, getLeads, getActivities } from '@/lib/actions'
...
export default function EditTaskPage({ params }: { params: { id: string } }) {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const [taskData, customersData, leadsData, activitiesData] = await Promise.all([
          getTask(params.id),
          getCustomers(),
          getLeads(),
          getActivities()
